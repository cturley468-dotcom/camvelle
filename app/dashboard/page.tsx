  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020202] text-[#f5f1e8]">
      ...
      <section className="relative z-10 px-5 pb-24 pt-4 md:px-10">
        ...
        <div className="w-full max-w-2xl rounded-[3rem] border border-white/10 bg-white/[0.035] p-8 text-center transition duration-500 hover:border-white/20 hover:bg-white/[0.05] md:p-10">
              <div>
